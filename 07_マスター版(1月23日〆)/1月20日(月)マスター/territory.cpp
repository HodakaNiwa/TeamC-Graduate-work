...
#define SHADOW_SIZE		(D3DXVECTOR3(43.0f, 0.0f, 43.0f))	//影のサイズ
...
void CTerritory::SetErea(void)
{
	...
	//エリアの始点を求める
	D3DXVECTOR2 FirstPos = D3DXVECTOR2(-60.0f, 0.0f);
	FirstPos.x = ((FIELD_SIZE.x * 0.5f) * -1) - 60.0f;
