...
//    コンストラクタ
//=============================================================================
CShadowShader::CShadowShader(char *pFileName) : CShader(pFileName)
{
...
//    生成処理
//=============================================================================
CShadowShader *CShadowShader::Create(char *pFileName)
{
	// メモリの作成
	CShadowShader *pShadowShader = NULL;
	pShadowShader = new CShadowShader(pFileName);
	if (pShadowShader == NULL) { return NULL; }

	// 初期化処理
	if (FAILED(pShadowShader->Init()))
	{
		pShadowShader->Uninit();
		delete pShadowShader;
		return NULL;
	}

	return pShadowShader;
}

//=============================================================================
//    初期化処理
//=============================================================================
HRESULT CShadowShader::Init(void)
{
	// デバイスの取得
...
//    シェーダーに各種値を設定する
//=============================================================================
void CShadowShader::SetParamToEffect(void)
{
	if (m_pEffect != NULL)
	{
