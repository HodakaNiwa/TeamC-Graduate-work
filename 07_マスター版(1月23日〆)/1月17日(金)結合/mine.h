...
private:   // このクラスだけがアクセス可能
	...
	void CollisionCollider(CCollider *pCollider, D3DXVECTOR3 pos, float fLength);
	bool CollisionPlayerAttackSphereCollider(CPlayerAttackSphereCollider *pShere, D3DXVECTOR3 pos, float fLength);
