...
//スコアフレーム
#define SCORE_FREAM	("data/TEXTURE/game/scoreword1.png")
...
//
//=============================================================================
LPDIRECT3DTEXTURE9 CScoreGame::m_pTexture = NULL;
...
// テクスチャの読み込み
//=============================================================================
void CScoreGame::LoadTex(void)
{
	//デバイスの取得
	LPDIRECT3DDEVICE9 pDevice = CManager::GetRenderer()->GetDevice();

	//国旗テクスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, SCORE_FREAM, &m_pTexture);
...
// テクスチャの破棄
//=============================================================================
void CScoreGame::UnloadTex(void)
{
	if (m_pTexture != NULL)
	{//国旗テクスチャの破棄
		m_pTexture->Release();
