...
// ポリゴンの値設定用
#define SKILICON_POLYGON_POS_0  (D3DXVECTOR3(35.0f,35.0f,0.0f))
#define SKILICON_POLYGON_POS_1  (D3DXVECTOR3(1245.0f,35.0f,0.0f))
#define SKILICON_POLYGON_POS_2  (D3DXVECTOR3(35.0f,685.0f,0.0f))
#define SKILICON_POLYGON_POS_3  (D3DXVECTOR3(1245.0f,685.0f,0.0f))

#define SKILICON_POLYGON_WIDTH  (60.0f)
#define SKILICON_POLYGON_HEIGHT (60.0f)
