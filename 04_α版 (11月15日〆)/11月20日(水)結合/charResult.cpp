...
//オブジェクトの生成処理
//=============================================================================
CCharResult *CCharResult::Create(D3DXVECTOR3 pos, char ModelTxt[40], char MotionTxt[40], CHARCTERTYPE charactertype, int nCharaNum)
{
	...
	if (pPlayer == NULL)
	{
		...
		{//NULLチェック
			...
			pPlayer->Init(pos, ModelTxt,MotionTxt, nCharaNum);
		}
		else
		{
