...
//オブジェクトの生成処理
//=============================================================================
CPowerPlayer *CPowerPlayer::Create(D3DXVECTOR3 pos, char ModelTxt[40], char MotionTxt[40], int nNumPlayer, int nType, CHARCTERTYPE charctertype)
{
	...
	if (pPowerplayer == NULL)
	{
		...
		{//NULLチェック
			...
			pPowerplayer->m_nResultCuntry[nNumPlayer] = nType;					//リザルト用の国タイプ
			...
			pPowerplayer->Init(pos, ModelTxt, MotionTxt, nNumPlayer);		//プレイヤーの初期化
		}
		else
		{
