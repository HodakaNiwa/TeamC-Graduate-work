...
void CResultCharUI::LoadMultRendering(int nCuntry, int nType)
{
	...
	case CCharacter::TYPE_JAPAN:	//日本
		if (nType == 0)
		{
			m_pCharMultRender = CCharMultRender::Create(INITIALIZE_VECTOR3, "data\\TEXT\\ModelLoad\\SPEEDPLAYER_LOAD.txt", "data\\TEXT\\MotionLoad\\SPEEDPLAYER_MOTION.txt");
		}
		else if (nType == 1)
		{
			m_pCharMultRender = CCharMultRender::Create(INITIALIZE_VECTOR3, "data\\TEXT\\ModelLoad\\POWERPLAYER_LOAD.txt", "data\\TEXT\\MotionLoad\\POWERPLAYER_MOTION.txt");
		}
		else
		{
			m_pCharMultRender = CCharMultRender::Create(INITIALIZE_VECTOR3, "data\\TEXT\\ModelLoad\\PLAYER_LOAD.txt", "data\\TEXT\\MotionLoad\\PLAYER_MOTION.txt");
		}
		break;
