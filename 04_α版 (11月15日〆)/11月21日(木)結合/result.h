...
#define CUNTRY					(8)		// 国の数
#define RESULT_TEX				(18)	// リザルトのテクスチャ
...
private:
	...
	CScore * m_pTotalScore[MAX_CHARACTER];				//スコア
	CScore * m_pGetScore[MAX_CHARACTER];				//スコア
	CScore * m_pMakeScore[MAX_CHARACTER];				//スコア
	CScore * m_pRobotedScore[MAX_CHARACTER];				//スコア
