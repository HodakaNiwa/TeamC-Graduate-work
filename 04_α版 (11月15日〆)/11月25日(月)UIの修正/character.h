...
protected:
	...
	void GetTerritory(CTerritory * pTerritory, int nNumLightOrbit = 0);	//テリトリーの取得
...
private:
	...
	void CutTerritoryPoint(CTerritory * pTerritory, int nOldPlayer, int nNumLightOrbit);	// テリトリースコアの削除
	void CreateLightOrbit(CGame *pGame, const int nOldPlayer);								// 光の軌跡を作る処理
