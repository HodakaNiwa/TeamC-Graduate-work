...
HRESULT CRenderer::Init(HWND hWnd, bool bWindow)
{
	...
	{
		m_pDebugWindow = CDebugWindow::Create();
	}
...
{	
	...
	{
		bool bGuiDraw = CGui::GetDraw();
		bGuiDraw = bGuiDraw ? false : true;
		CGui::SetDraw(bGuiDraw);
	}
	...
	//ウインドウの更新処理
	if (m_pDebugWindow != NULL) { m_pDebugWindow->Update(); }
