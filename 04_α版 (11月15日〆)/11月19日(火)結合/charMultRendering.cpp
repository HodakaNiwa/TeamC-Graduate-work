...
//オブジェクトの生成処理
//=============================================================================
CCharMultRender *CCharMultRender::Create(D3DXVECTOR3 pos, char ModelTxt[40], char MotionTxt[40],CHARCTERTYPE charctertype, int nNumCharaIdx)
{
	...
	if (pPlayer == NULL)
	{
		...
		{//NULLチェック
			...
			pPlayer->Init(pos, ModelTxt,MotionTxt, nNumCharaIdx);
		}
		else
		{
