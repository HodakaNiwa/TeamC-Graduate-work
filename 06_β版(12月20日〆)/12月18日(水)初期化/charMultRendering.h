...
public:
	...
	{//プレイヤーの状態
		...
		MOTION_TYPE_BLOWAWAY,	//ぶつかる
		MOTION_TYPE_DOWN,		//ダウン
		MOTION_TYPE_WAKEUP,		//起き上がる
		MOTION_TYPE_WIN,		//勝った
		MOTION_TYPE_LOSE,		//負けた
		MOTION_TYPE_SELECT,		//待機
		MOTION_TYPE_MAX
	}MOTION_TYPE;
...
protected:							//親と子クラスが使用できる
	...
	MOTION_TYPE m_MotionType;			//モーションのタイプ
...
private:
	...
	bool			   m_bStopMotion;	// モーションの更新フラグ
	CModel *		   m_pModelMine;	// 地雷のモデル
};
#endif