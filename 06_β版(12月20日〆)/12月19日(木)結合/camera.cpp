...
#define LENGTH_Y		(500.0f)	//視点と注視点の距離（Ｙ） 500.0f
...
// 初期化処理
//=============================================================================
void CGameCamera::Init(CCharacter *pPlayer)
{
	CCamera::Init();
...
{
	m_EndPosV = INITIALIZE_VECTOR3;
	m_EndPosR = INITIALIZE_VECTOR3;
	m_ZoomOutPos = INITIALIZE_VECTOR3;
	m_TargetCharPos = INITIALIZE_VECTOR3;
	m_MoveV = INITIALIZE_VECTOR3;
	m_MoveR = INITIALIZE_VECTOR3;
	m_nCountTime = 0;
	m_state = STATE_CHAR_STOP;
}
