...
CMeshRing *CMeshRing::Create(D3DXVECTOR3 pos, D3DXVECTOR3 rot, D3DXCOLOR col, float fHeight, float fRadius, float fDiffusion, int nXBlock, int nYBlock, int nPriority)
{
	...
	pMeshRing->SetDiffusion(fDiffusion);	// メッシュリングの幅
...
//    トランスフォーム情報を計算する処理
//=============================================================================
void CMeshRing::CalcNotScaleTransform(void)
{
...
//=============================================================================
void CMeshRing::SetTransformToDevice(const LPDIRECT3DDEVICE9 pDevice)
{
...
//    頂点バッファに値を設定する
//=============================================================================
void CMeshRing::SetVtxBuffValue(void)
{
	// 頂点情報の設定
	VERTEX_3D *pVtx;
...
//    頂点バッファに頂点座標を設定する
//=============================================================================
void CMeshRing::SetVtxBuffPos(void)
{
...
//    頂点バッファに法線を設定する
//=============================================================================
void CMeshRing::SetVtxBuffNor(void)
{
...
//    頂点バッファに頂点カラーを設定する
//=============================================================================
void CMeshRing::SetVtxBuffCol(void)
{
	// 頂点情報の設定
	VERTEX_3D *pVtx;
...
//    頂点バッファにテクスチャ座標を設定する
//=============================================================================
void CMeshRing::SetVtxBuffTex(void)
{
...
//    変数をクリアする
//=============================================================================
void CMeshRing::ClearVariable(void)
{
	// 各種値のクリア
	m_pVtxBuff = NULL;					// 頂点バッファへのポインタ
	m_pIdxBuff = NULL;					// インデックスバッファへのポインタ
	m_pTexture = NULL;					// テクスチャへのポインタ
	m_Pos = INITIALIZE_VECTOR3;			// メッシュリングの位置
	m_Rot = INITIALIZE_VECTOR3;			// メッシュリングの向き
	D3DXMatrixIdentity(&m_MtxWorld);	// メッシュリングのワールドマトリックス
	m_Col = INITIALIZE_VECTOR4;			// メッシュリングの色
