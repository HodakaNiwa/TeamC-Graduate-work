...
public:
	...
	void SetPosVertex(D3DXVECTOR3 pos);
	void SetRotPos(float fAngle);

	//ポリゴンのサイズ
	D3DXVECTOR3 GetSize(void);
	void SetSize(const D3DXVECTOR3 size);
	void SetSizeVertex(float fHight, float fHight2);
	...
	//左右反転
	void SetReflectRightLeft(void);	//左右反転
...
private:
	...
	float						m_fHight;		// ポリゴンの高さ
	float						m_fHight2;		// ポリゴンの高さ２
};
#endif