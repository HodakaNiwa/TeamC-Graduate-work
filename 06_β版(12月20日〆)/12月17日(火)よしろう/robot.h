...
#define ROBOT_VIGILANCESPEED		(20.0f)		// 移動速度
...
#define ROBOT_ATTACK_INTERVAL		(50)		// 攻撃(近接)の間隔
#define ROBOT_SHOOT_MODEINTERVAL	(5)			// 攻撃(遠距離)の間隔
#define ROBOT_SHOOT_BULLETINTERVAL	(10)		// ミサイルを撃つ間隔
#define ROBOT_SHOOT_MAXBULLET		(10)		// ミサイルを撃つ回数
#define ROBOT_GRAVITY				(-9.8f)		// 重力(-9.8m/s^2)
#define ROBOT_ENDTIME				(2700)		// 出現時間
#define ROBOT_SWITCHTIME			(300)		// 追跡時間

#define ROBOT_UNINITPOS				(1000)		// 消える時のY軸座標
#define ROBOT_ATTACKEFFECT			(25)		// 攻撃エフェクトのタイミング
