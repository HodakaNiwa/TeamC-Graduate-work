...
void CGame::Init(void)
{
	...
	CCrack::LoadTex();					//ひび割れ　
	CRipples::LoadTex();				//波紋　
	CNumberBillborad::LoadTex();		//ナンバー　安
	CPoint::LoadTex();					//プラス　安
...
void CGame::CreateInitCamera(void)
{
	...
	{//プレイ人数が1人だったら
	 //カウントダウンタイマーの生成　
	 CTimer::Create(CTimer::TYPE_COUNTER, 7, D3DXVECTOR3(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, 0.0f), TIMER_SIZE);

	 //ゲームタイマーの生成（ラスト5秒で描画される）　
	 CTimer::Create(CTimer::TYPE_GAME, 7, D3DXVECTOR3(SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2, 0.0f), TIMER_SIZE);
	...
	{//プレイ人数が2人だったら
		 ...
		 //カウントダウンタイマーの生成 
		CTimer::Create(CTimer::TYPE_COUNTER, 7, D3DXVECTOR3(SCREEN_WIDTH / 4, SCREEN_HEIGHT / 2, 0.0f), TIMER_SIZE);
		CTimer::Create(CTimer::TYPE_GAME, 7, D3DXVECTOR3(SCREEN_WIDTH / 4, SCREEN_HEIGHT / 2, 0.0f), TIMER_SIZE);
	...
	{//プレイ人数が3人だったら
		...
		//カウントダウンタイマーの生成　
		CTimer::Create(CTimer::TYPE_COUNTER, 7, D3DXVECTOR3(SCREEN_WIDTH / 4, SCREEN_HEIGHT / 4, 0.0f), TIMER_SIZE_4);
		CTimer::Create(CTimer::TYPE_GAME, 7, D3DXVECTOR3(SCREEN_WIDTH / 4, SCREEN_HEIGHT / 4, 0.0f), TIMER_SIZE_4);
