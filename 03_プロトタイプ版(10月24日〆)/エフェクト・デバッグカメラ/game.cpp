...
void CGame::Init(void)
{
	...
	//プレイヤーの生成
	m_pPlayer[0] = CPlayer::Create(D3DXVECTOR3(-50.0f, 0.0f, 0.0f), CPlayer::NUM_PLAYER_01, "data\\TEXT\\PLAYER_LODE.txt", "data\\TEXT\\PLAYER_MOTION.txt", CPlayer::TYPE_SOUTHAFRICA);
	m_pPlayer[1] = CPlayer::Create(D3DXVECTOR3(0.0f, 0.0f, 0.0f), CPlayer::NUM_PLAYER_02, "data\\TEXT\\PLAYER_LODE.txt", "data\\TEXT\\PLAYER_MOTION.txt", CPlayer::TYPE_AMERICA);
	m_pPlayer[2] = CPlayer::Create(D3DXVECTOR3(50.0f, 0.0f, 0.0f), CPlayer::NUM_PLAYER_03, "data\\TEXT\\PLAYER_LODE.txt", "data\\TEXT\\PLAYER_MOTION.txt", CPlayer::TYPE_ENGLAND);
	m_pPlayer[3] = CPlayer::Create(D3DXVECTOR3(100.0f, 0.0f, 0.0f), CPlayer::NUM_PLAYER_04, "data\\TEXT\\PLAYER_LODE.txt", "data\\TEXT\\PLAYER_MOTION.txt", CPlayer::TYPE_ITALY);
