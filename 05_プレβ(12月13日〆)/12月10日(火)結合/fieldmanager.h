...
public:
	...
	CField *GetEventField(void) { return m_pEventField; }
...
private:
	...
	void SetFieldVertex_Event(void);
	void SetFieldMtxWorld_Event(void);
	void SetFieldColor_Event(void);
};
#endif
