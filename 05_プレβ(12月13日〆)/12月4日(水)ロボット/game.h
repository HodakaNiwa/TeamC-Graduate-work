...
public:
	...
	void SetRobot(CRobot *pRobot) { m_pRoboCharacter = pRobot; }	// ←追加(よしろう)
	CRobot *GetRobot(void) { return m_pRoboCharacter; }				// ←追加(よしろう)

	void SetEveCam(CEventCamera *pEventCamera) { m_pEventCamera = pEventCamera; }	// ←追加(よしろう)
	CEventCamera *GetEveCam(void) { return m_pEventCamera; }						// ←追加(よしろう)

	void SetEveCamFlag(bool EndFlag) { m_bEveCam = EndFlag; }		// ←追加(よしろう)
	bool GetEVeCamFlag(void) { return m_bEveCam; }		// ←追加(よしろう)
...
private:
	...
	void ReleaseRobotUI(void);		   // ←追加(よしろう)
	void UpdateRobotUI(void);		   // ←追加(よしろう)
	void DrawRobotUI(void);			   // ←追加(よしろう)
	...
	CEventCamera *m_pEventCamera;				// イベントカメラ←追加(よしろう)
