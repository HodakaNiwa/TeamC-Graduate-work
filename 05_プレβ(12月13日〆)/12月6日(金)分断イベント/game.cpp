...
// エリアボーナスイベント用
#define AREABONUSEVENT_CAMERA_POSV			(D3DXVECTOR3(-30.0f, 2700.0f, -10.0f))
#define AREABONUSEVENT_CAMERA_POSR			(D3DXVECTOR3(-30.0f, 0.0f, 70.0f))
...
#define DIVISIONEVENT_TIME 					(15 * 60)
...
#define DIVISIONEVENT_COLLIDER_MIN			(50.0f)
