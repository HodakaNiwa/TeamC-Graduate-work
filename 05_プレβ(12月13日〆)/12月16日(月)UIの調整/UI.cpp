...
//     マクロ定義
//*****************************************************************************
//#define UI_USING_CHARAICON												// キャラアイコン(カービィのエアライド方式)を使うかどうか
#define UI_PRIORITY						(6)									// UIの描画優先順位

// ゲームスコア用
#define UI_GAMESCORE_POS_0				(D3DXVECTOR3(260.0f,28.0f,0.0f))	// 1Pのスコア
#define UI_GAMESCORE_POS_1				(D3DXVECTOR3(910.0f,28.0f,0.0f))	// 2Pのスコア
#define UI_GAMESCORE_POS_2				(D3DXVECTOR3(260.0f,685.0f,0.0f))	// 3Pのスコア
#define UI_GAMESCORE_POS_3				(D3DXVECTOR3(910.0f,685.0f,0.0f))	// 4Pのスコア
#define UI_GAMESCORE_POS_4				(D3DXVECTOR3(10000.0f,380.0f,0.0f))	// 敵のスコア(画面外へ配置)
#define UI_GAMESCORE_SIZE				(D3DXVECTOR3(30.0f,60.0f,0.0f))		// スコアの数字のサイズ
...
#define UI_SCORECHANGE_SIZE				(D3DXVECTOR3(43.0f,65.0f,0.0f))		// スコア変動クラスの大きさ
#define UI_SCORECHANGE_TEXIDX			(4)									// スコア変動クラスの使用するテクスチャの番号

// 画面エフェクト用
#define UI_SCREENEFFECT_ALPHA			(0.65f)								// 画面効果の透明度
